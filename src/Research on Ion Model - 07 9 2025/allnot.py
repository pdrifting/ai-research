...
# Expert model for bitwise gates
...
# Verifier for output correctness
...
def train_expert(op_name, bits, truth_fn, is_unary=False):
    ...
    if os.path.exists(path):
        ...
        try:
            ...
            print(f"Error loading {fname}: {e} — Retrying...")
    ...
    sample_count = 10000 if bits < 32 else 50000
    x_data, y_data = [], []
...
# Launch trainer (example from 2 to 32 bits)
