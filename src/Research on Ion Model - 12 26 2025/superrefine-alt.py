...
# --- CONFIGURATION ---
GPUS = [0, 1, 2]
BASE_FOLDER = "GENETIC_KINGS"    # Source of original unique paths
...
UNIQUE_PATHS = [
    "seed_401_base.pt", "seed_930_base.pt", "seed_1027_base.pt",
    "elite_S0.96593_911.pt", "elite_S0.96900_2316.pt", "elite_S0.96685_3131.pt",
    "elite_S0.96643_3021.pt", "elite_S0.96515_2929.pt", "elite_S0.96520_2894.pt"
]
