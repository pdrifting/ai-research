...
void createLogicalDevice(VulkanApp* app) {
    ...
    uint32_t queueFamilyCount = sizeof(uniqueQueueFamilies) / sizeof(uniqueQueueFamilies[0]);
    ...
    vkGetDeviceQueue(app->device, indices.presentFamily, 0, &app->graphicsQueue);
}
